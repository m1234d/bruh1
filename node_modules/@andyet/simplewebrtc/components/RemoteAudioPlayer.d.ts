...
export declare class RemoteAudioPlayer extends React.Component<RemoteAudioPlayerProps, any> {
    shouldComponentUpdate(newProps: RemoteAudioPlayerProps): boolean;
    render(): JSX.Element;
}
declare const _default: import("react-redux").ConnectedComponent<typeof RemoteAudioPlayer, Pick<React.ClassAttributes<RemoteAudioPlayer> & RemoteAudioPlayerProps, "key" | "ref">>;
