 ...
 * @param volumeMonitoring If explicitly set to `false`, disable volume and speech detection monitoring.
 */
export interface RequestUserMediaProps {
    ...
    addLocalAudio?: (track: MediaStreamTrack, stream: MediaStream, replace?: string, volumeMonitoring?: boolean) => void;
