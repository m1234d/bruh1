 ...
 * @param replaces
 */
export declare function addLocalAudio(track: MediaStreamTrack, stream: MediaStream, replaces?: string, monitorVolume?: boolean): ThunkAction<void, State, void, AddMedia | RemoveMedia>;
/**
 * @description
