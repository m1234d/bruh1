...
function spawnPlayer(userparam, avatarparam, callback) {
    ...
    mtlLoader.load(avatarparam + "/" + avatarparam + ".mtl", mtlParseResult => {
        console.log("Spawn 2: " + userparam)
        const materials = MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
        const objLoader = new OBJLoader2();
        objLoader.addMaterials(materials);
        console.log("Spawn 3: " + userparam)
        objLoader.load(avatarparam + "/" + avatarparam + ".obj", obj => { 
            obj.name = userparam
            obj.position.x = 5
            obj.position.y = 0.7
...
//   }
    ...
    const mtlLoader = new MTLLoader();
    mtlLoader.load("townSquare/townSquareMagica.mtl", mtlParseResult => {
        const materials = MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
        const objLoader = new OBJLoader2();
        objLoader.addMaterials(materials);
        objLoader.load("townSquare/townSquareMagica.obj", obj => { 
            obj.name = "townSquare"
            scene.add(obj) });
    });
  }
